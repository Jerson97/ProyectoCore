...
const RegistrarUsuario = () =>{
    ...
    const registrarUsuarioBoton = e => {
        e.preventDefault();  //esto detiene que la pagina se refresque
                ...
                <form style={style.form}>
                    <Grid container spacing={2}>
                        <Grid item xs={12} md={12}>
                            <TextField name="NombreCompleto"value={usuario.NombreCompleto} onChange={ingresarValoresMemoria} variant="outlined" fullWidth label="Ingrese sus nombre" />
                        </Grid>
